...
extract-data:
	...
	@mkdir -p export
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.SAMPLEGROUP --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/samplegroup.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.CONTAINERTYPE --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/containertype.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.CONTAINER --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/container.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.VIEW_SAMPLE_MASTER --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/sample.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.SAMPLE_10003 --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/sample_10003.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.SAMPLE_10004 --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/sample_10004.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.SAMPLE_10029 --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/sample_10029.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)' || echo "SAMPLE_10029 table not present in DB2, skipping."
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.CV_QUALITY --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/cv_sample_quality.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.SAMPLE_QUALITY --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/sample_quality.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.BATCH_LIST --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/batch_list.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BIOBANK3.BATCH_SAMPLE_LIST --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/batch_sample_list.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BCPROJECT.PROJECT --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/project.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BCPROJECT.PARTNER --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/partner.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
	@$(EXPORTER_DIR)/gradlew -p $(EXPORTER_DIR) bootRun --args='--table=BCPROJECT.PROJECT_MEMBERSHIP --output=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/project_membership.csv --spring.datasource.url=$(DB2_URL) --spring.datasource.username=$(DB2_USER) --spring.datasource.password=$(DB2_PASSWORD)'
...
load-target:
	...
	@$(IMPORTER_DIR)/gradlew -p $(IMPORTER_DIR) bootRun --args='--csv=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/project.csv --manifest=/Users/muilu/git/others/biobank-solution/sample-service-migration/config/manifests/project_manifest.yaml --spring.datasource.url=$(PG_URL) --spring.datasource.username=$(PG_USER) --spring.datasource.password=$(PG_PASSWORD) --spring.datasource.driver-class-name=org.postgresql.Driver --spring.main.web-application-type=none'
	...
	@$(IMPORTER_DIR)/gradlew -p $(IMPORTER_DIR) bootRun --args='--csv=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/batch_sample_list.csv --manifest=/Users/muilu/git/others/biobank-solution/sample-service-migration/config/manifests/work_list_item_manifest.yaml --spring.datasource.url=$(PG_URL) --spring.datasource.username=$(PG_USER) --spring.datasource.password=$(PG_PASSWORD) --spring.datasource.driver-class-name=org.postgresql.Driver --spring.main.web-application-type=none'
	...
	@$(IMPORTER_DIR)/gradlew -p $(IMPORTER_DIR) bootRun --args='--csv=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/work_list_event.csv --manifest=/Users/muilu/git/others/biobank-solution/sample-service-migration/config/manifests/work_list_event_manifest.yaml --spring.datasource.url=$(PG_URL) --spring.datasource.username=$(PG_USER) --spring.datasource.password=$(PG_PASSWORD) --spring.datasource.driver-class-name=org.postgresql.Driver --spring.main.web-application-type=none'
	...
	@$(IMPORTER_DIR)/gradlew -p $(IMPORTER_DIR) bootRun --args='--csv=/Users/muilu/git/others/biobank-solution/sample-service-migration/export/legacy_event.csv --manifest=/Users/muilu/git/others/biobank-solution/sample-service-migration/config/manifests/event_manifest.yaml --spring.datasource.url=$(PG_URL) --spring.datasource.username=$(PG_USER) --spring.datasource.password=$(PG_PASSWORD) --spring.datasource.driver-class-name=org.postgresql.Driver --spring.main.web-application-type=none'
